  ...
  return (
    <div className='mainDiv'>
        <div className='mainBody'>
            ...
            <Link to="/Projects">
            <button className='font-AlbertSans bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded m-4'>Projects</button>
            </Link>
            <Link to="/Blogs">
