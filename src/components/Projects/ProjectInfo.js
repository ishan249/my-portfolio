...
const projectInfo = [
  {
    ...
    projectDescription: "DesignFolio is a personal landing page builder. You can have your personal URL linked to your portfolio which has your skills, projects and other information.",
  ...
  },
  {
    ...
    projectDescription: "Website which will fetch the data of top post from some famous subreddits and show it to users.",
  ...
  },
  {
    ...
    projectDescription: "Website which will use SERP api and fetch the data of good hangout places like cafes/restuarant nearby given address.",
  ...
  },
  {
    ...
    projectDescription: "Hotel booking management system in which all CRUD operations are implemented. Used MongoDB atlas for managing database.",
